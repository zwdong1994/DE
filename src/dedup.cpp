...
void dedup::travel_dir_nonewcache(char *path) {
    DIR *pdir;
    struct dirent *ent;
    char child_path[512];
    pdir = opendir(path);
...
int dedup::file_reader_nonewcache(char *path) {
...
int dedup::sha256_file_reader_nonewcache(char *path) {
